            ...
            <form onSubmit={submitCredentials} className="space-y-4">
              ...
              <label className="block text-sm font-medium auth-reveal">Senha
                <div className="relative mt-1.5 h-12">
                  ...
                  <button type="button" aria-label={showPassword ? "Ocultar senha" : "Mostrar senha"} onClick={() => setShowPassword((value) => !value)} className="absolute right-3 top-1/2 z-20 flex h-8 w-8 -translate-y-1/2 items-center justify-center rounded-lg p-0 leading-none text-muted-foreground transition-colors hover:bg-muted hover:text-foreground active:scale-90">
