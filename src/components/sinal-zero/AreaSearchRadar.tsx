  ...
  return (
    <>
      ...
      <style>{`
        ...
        .area-search-radar__field::before,.area-search-radar__field::after{content:"";position:absolute;inset:0;pointer-events:none}
        .area-search-radar__field::before{background:repeating-radial-gradient(ellipse 72% 184% at 50% 50%,transparent 0 10.8%,rgba(255,173,0,.10) 10.95% 11.08%,transparent 11.22% 21.7%);opacity:.7}
        .area-search-radar__field::after{background:repeating-conic-gradient(from 0deg at 50% 50%,rgba(255,173,0,.065) 0deg .4deg,transparent .4deg 15deg);opacity:.38;-webkit-mask:radial-gradient(ellipse 78% 196% at 50% 50%,#000 0 96%,transparent 100%);mask:radial-gradient(ellipse 78% 196% at 50% 50%,#000 0 96%,transparent 100%)}
        .area-search-radar__ambient{position:absolute;left:-20%;right:-20%;top:-90%;bottom:-90%;border-radius:50%;background:radial-gradient(ellipse at 50% 50%,rgba(255,173,0,.13) 0%,rgba(255,173,0,.055) 30%,rgba(255,173,0,.02) 58%,transparent 78%);filter:blur(3px);animation:sz-radar-ambient 3.8s ease-in-out infinite}
        ...
        .area-search-radar__ring{position:absolute;left:50%;top:50%;transform:translate(-50%,-50%);border-radius:50%;border:1px solid rgba(255,173,0,.20);box-shadow:0 0 36px -28px rgba(255,173,0,.95)}
        .area-search-radar__ring--outer{width:138%;height:276%;opacity:.55}.area-search-radar__ring--middle{width:104%;height:208%;opacity:.70}.area-search-radar__ring--inner{width:72%;height:144%;opacity:.86}.area-search-radar__ring--core{width:40%;height:80%;border-color:rgba(255,205,85,.32)}
        ...
        .area-search-radar__beam{background:conic-gradient(from -10deg at 50% 50%,rgba(255,224,122,.34),rgba(255,173,0,.16) 13deg,rgba(255,173,0,.045) 31deg,transparent 50deg);clip-path:polygon(50% 50%,100% 0,100% 57%);mix-blend-mode:screen;opacity:.92}
        ...
        .area-search-radar__blip{position:absolute;z-index:3;width:7px;height:7px;border-radius:50%;background:#ffbf3f;box-shadow:0 0 11px 3px rgba(255,173,0,.58);opacity:.62;animation:sz-radar-blip 2.7s ease-in-out infinite}.area-search-radar__blip--one{left:8%;top:8%;animation-delay:.2s}.area-search-radar__blip--two{left:79%;top:7%;animation-delay:1s}.area-search-radar__blip--three{left:91%;top:84%;animation-delay:1.8s}.area-search-radar__blip--four{left:7%;top:91%;animation-delay:2.25s}.area-search-radar__blip--five{left:35%;top:4%;animation-delay:.75s}.area-search-radar__blip--six{left:64%;top:94%;animation-delay:1.45s}.area-search-radar__blip--seven{left:23%;top:56%;animation-delay:2.05s}.area-search-radar__blip--eight{left:82%;top:46%;animation-delay:.45s}
