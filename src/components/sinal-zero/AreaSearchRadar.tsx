...
export function AreaSearchRadar({ verifying = false }: AreaSearchRadarProps) {
  return (
    <>
      ...
      <style>{`
        .area-search-radar{position:relative;width:96px;height:96px;flex:0 0 96px;border-radius:50%;isolation:isolate;display:block;background:radial-gradient(circle,rgba(255,224,122,.12) 0 2px,transparent 3px),radial-gradient(circle,rgba(255,173,0,.08),transparent 68%);border:1px solid rgba(255,173,0,.25);box-shadow:0 0 42px -18px rgba(255,173,0,.76),inset 0 0 28px rgba(255,173,0,.05);overflow:hidden;transform:translateZ(0);animation:sz-radar-breathe 3.2s ease-in-out infinite}
        ...
        .area-search-radar__beam{position:absolute;inset:4px;border-radius:50%;background:conic-gradient(from -12deg,rgba(255,224,122,.22),rgba(255,173,0,.05) 18deg,transparent 46deg);clip-path:polygon(50% 50%,100% 0,100% 50%);mix-blend-mode:screen;transform-origin:50% 50%;animation:sz-radar-sweep 2.45s linear infinite}
